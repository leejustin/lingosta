    ...
    <div className="mx-auto p-5">
      <div className="mx-auto w-full py-8 text-center justify-center space-y-12">
        <div className="space-y-4">
          ...
          <div>
            <p>
              Lingosta is a language-learning app that uses AI to generate curated exercises, making it more
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white shadow-lg p-6 rounded-3xl text-left space-y-2">
            ...
            <p className="">
              With Lingosta, you can easily translate sentences from English into various languages. The translated words
