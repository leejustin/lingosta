  ...
  return (
    <div>
      ...
      <div className='mt-5 px-6 md:p-0 flex max-w-lg mx-auto '>
        <div
          className='flex-grow flex flex-col justify-center p-5 border-[1px] bg-slate-200 border-neutral-300 rounded-xl'>
          ...
          <p className='text-xs text-gray-500 text-center mt-4'>
            By signing up for Lingosta, you confirm that you have read, understood, and agreed to our <a
            className="underline text-blue-600 hover:text-blue-800 visited:text-purple-600" href="#"
            onClick={() => setShowPrivacyPolicyModal()}>Privacy Policy</a> and <a
            className="underline text-blue-600 hover:text-blue-800 visited:text-purple-600" href="#"
            onClick={() => setShowTermsAndConditionsModal()}>Terms and Conditions</a>.
          </p>
        </div>
      </div>
      <div className='mt-5 px-6 md:p-0 flex max-w-lg mx-auto '>
      ...
      <InfoModal isOpen={showInfoModal} closeModal={() => setShowInfoModal(false)} modalTitle={infoModalTitle}
